...
if(MINGW)
    target_compile_options(libmaxminddb PRIVATE -Wno-error=declaration-after-statement)
    target_compile_options(libmaxminddb PRIVATE -Wno-declaration-after-statement)
endif()
