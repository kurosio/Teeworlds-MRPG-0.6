...
find_path(MARIADB_INCLUDEDIR
  ...
  HINTS ${HINTS_MARIADB_INCLUDEDIR} ${MARIADB_CONFIG_INCLUDE_DIR}
  ${CROSSCOMPILING_NO_CMAKE_SYSTEM_PATH}
)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(MariaDB DEFAULT_MSG MARIADB_LIBRARY MARIADB_INCLUDEDIR)

if(MARIADB_FOUND)
  is_bundled(MARIADB_BUNDLED "${MARIADB_LIBRARY}")
  set(MARIADB_LIBRARIES ${MARIADB_LIBRARY})
  set(MARIADB_INCLUDE_DIRS ${MARIADB_INCLUDEDIR} ${Boost_INCLUDE_DIRS})
