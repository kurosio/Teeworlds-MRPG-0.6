...
class ServerSound(Struct):
	def __init__(self, name="", filename=""):
		Struct.__init__(self, "CDataServerSound")
		self.id = Int(0)
...
class DataContainer(Struct):
	def __init__(self):
		...
		self.server_sounds = Array(ServerSound())
...
# Server sounds
container.server_sounds.Add(ServerSound("game_accept", "game_accept.opus"))
container.server_sounds.Add(ServerSound("game_aether_teleport", "game_aether_teleport.opus"))
container.server_sounds.Add(ServerSound("game_boss_respawn", "game_boss_respawn.opus"))
container.server_sounds.Add(ServerSound("game_done", "game_done.opus"))
container.server_sounds.Add(ServerSound("game_farm", "game_farm.opus"))
container.server_sounds.Add(ServerSound("game_mine", "game_mine.opus"))
container.server_sounds.Add(ServerSound("game_pick_up", "game_pick_up.opus"))
container.server_sounds.Add(ServerSound("game_potion_start", "game_potion_start.opus"))
container.server_sounds.Add(ServerSound("game_skill_start", "game_skill_start.opus"))
container.server_sounds.Add(ServerSound("game_wanted", "game_wanted.opus"))
container.server_sounds.Add(ServerSound("menu_change_class", "menu_change_class.opus"))
container.server_sounds.Add(ServerSound("menu_click", "menu_click.opus"))
container.server_sounds.Add(ServerSound("menu_craft", "menu_craft.opus"))
container.server_sounds.Add(ServerSound("menu_guild_group_accept", "menu_guild_group_accept.opus"))
container.server_sounds.Add(ServerSound("menu_item_click", "menu_item_click.opus"))
container.server_sounds.Add(ServerSound("menu_item_disassemble", "menu_item_disassemble.opus"))
container.server_sounds.Add(ServerSound("menu_item_drop", "menu_item_drop.opus"))
container.server_sounds.Add(ServerSound("menu_item_equip", "menu_item_equip.opus"))
container.server_sounds.Add(ServerSound("menu_upgrade", "menu_upgrade.opus"))
container.server_sounds.Add(ServerSound("menu_warehouse_buy", "menu_warehouse_buy.opus"))
container.server_sounds.Add(ServerSound("menu_warehouse_product_load", "menu_warehouse_product_load.opus"))
container.server_sounds.Add(ServerSound("menu_warehouse_product_unload", "menu_warehouse_product_unload.opus"))
container.server_sounds.Add(ServerSound("menu_warehouse_repair_items", "menu_warehouse_repair_items.opus"))
container.server_sounds.Add(ServerSound("menu_warehouse_sell", "menu_warehouse_sell.opus"))
container.server_sounds.Add(ServerSound("weapons_gun_pulse_start", "weapons_gun_pulse_start.opus"))
container.server_sounds.Add(ServerSound("weapons_hammer_lamp_start", "weapons_hammer_lamp_start.opus"))
container.server_sounds.Add(ServerSound("weapons_magnet_impulse_end", "weapons_magnet_impulse_end.opus"))
container.server_sounds.Add(ServerSound("weapons_magnet_impulse_start", "weapons_magnet_impulse_start.opus"))
container.server_sounds.Add(ServerSound("weapons_pizdamet_start", "weapons_pizdamet_start.opus"))
container.server_sounds.Add(ServerSound("weapons_tracked_plazma_start", "weapons_tracked_plazma_start.opus"))
container.server_sounds.Add(ServerSound("weapons_wall_pusher_bullet", "weapons_wall_pusher_bullet.opus"))
container.server_sounds.Add(ServerSound("weapons_wall_pusher_start", "weapons_wall_pusher_start.opus"))
