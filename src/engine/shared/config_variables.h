...
MACRO_CONFIG_INT(SvMaxClients, sv_max_clients, MAX_PLAYERS, 1, MAX_PLAYERS, CFGFLAG_SAVE|CFGFLAG_SERVER, "Maximum number of clients that are allowed on a server")
