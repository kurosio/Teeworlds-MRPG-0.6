...
MACRO_CONFIG_INT(SvConnFloodGlobalRate, sv_conn_flood_global_rate, 40, 0, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: sustained global attempts per second")
MACRO_CONFIG_INT(SvConnFloodGlobalBurst, sv_conn_flood_global_burst, 120, 0, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: burst bucket for global attempts")
MACRO_CONFIG_INT(SvConnFloodSubnetLimit, sv_conn_flood_subnet_limit, 30, 0, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: attempts per subnet within window")
...
MACRO_CONFIG_INT(SvConnFloodSubnetBurst, sv_conn_flood_subnet_burst, 24, 1, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: burst tokens for subnet limiter")
