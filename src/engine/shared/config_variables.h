...
MACRO_CONFIG_INT(SvMapsHttpsDownload, sv_maps_https_download, 0, 0, 1, CFGFLAG_SERVER, "If server should send https url for map download")
...
MACRO_CONFIG_INT(SvUntranslateCollect, sv_untranslate_collect, 0, 0, 1, CFGFLAG_SERVER, "Collect untranslated server localization lines into their language files")
...
MACRO_CONFIG_INT(SvConnFloodGlobalRate, sv_conn_flood_global_rate, 18, 0, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: sustained global attempts per second")
MACRO_CONFIG_INT(SvConnFloodGlobalBurst, sv_conn_flood_global_burst, 54, 0, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: burst bucket for global attempts")
MACRO_CONFIG_INT(SvConnFloodSubnetLimit, sv_conn_flood_subnet_limit, 14, 0, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: attempts per subnet within window")
MACRO_CONFIG_INT(SvConnFloodSubnetWindow, sv_conn_flood_subnet_window, 6, 0, 60, CFGFLAG_SERVER, "Distributed conn flood protection: subnet window in seconds")
MACRO_CONFIG_INT(SvConnFloodSubnetBurst, sv_conn_flood_subnet_burst, 14, 1, 10000, CFGFLAG_SERVER, "Distributed conn flood protection: burst tokens for subnet limiter")
MACRO_CONFIG_INT(SvConnFloodSubnetBlockSeconds, sv_conn_flood_subnet_block_seconds, 2, 0, 60, CFGFLAG_SERVER, "Distributed conn flood protection: base subnet block duration")
MACRO_CONFIG_INT(SvConnFloodGlobalBlockSeconds, sv_conn_flood_global_block_seconds, 1, 0, 60, CFGFLAG_SERVER, "Distributed conn flood protection: base global block duration")
MACRO_CONFIG_INT(SvConnFloodTrustSeconds, sv_conn_flood_trust_seconds, 900, 0, 86400, CFGFLAG_SERVER, "Distributed conn flood protection: successful IP trust lifetime")
MACRO_CONFIG_INT(SvConnFloodPressure, sv_conn_flood_pressure, 80, 0, 100, CFGFLAG_SERVER, "Distributed conn flood protection: starts tightening when slots usage reaches this percentage")
