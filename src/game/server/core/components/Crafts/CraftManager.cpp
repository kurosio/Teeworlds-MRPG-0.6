...
void CCraftManager::ShowCraftItem(CPlayer* pPlayer, CCraftItem* pCraft) const
{
	...
	CVoteWrapper VCraftItem(ClientID, VWFLAG_SEPARATE_OPEN | VWFLAG_STYLE_STRICT_BOLD, "\u2692 Detail information about craft");
	...
	// add craft reciepts
	CVoteWrapper VCraftElement(ClientID, VWFLAG_SEPARATE_OPEN | VWFLAG_STYLE_STRICT, "Craft: {STR}", pCraftItemInfo->GetName());
...
void CCraftManager::ShowCraftList(CPlayer* pPlayer, const char* TypeName, ItemType Type) const
{
	...
	CVoteWrapper VCraftList(ClientID, VWFLAG_SEPARATE_OPEN, TypeName);
