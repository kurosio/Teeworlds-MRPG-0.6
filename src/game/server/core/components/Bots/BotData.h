...
enum MobBehaviorFlags
{
	...
	MOBFLAG_BEHAVIOR_HEALER_SKILLS = 1 << 5,
	MOBFLAG_BEHAVIOR_TANK_SKILLS = 1 << 6,
	MOBFLAG_BEHAVIOR_DPS_SKILLS = 1 << 7,
	MOBFLAG_BEHAVIOR_BASE_SKILLS = 1 << 8,
	MOBFLAG_BEHAVIOR_AMBIENT_CHAT = 1 << 9,
};
