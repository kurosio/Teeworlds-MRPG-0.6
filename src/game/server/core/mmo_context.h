...
enum ESkill
{
	...
	SKILL_MASTER_ADVENTURER = 14, // master adventurer
	NUM_SKILLS,
};
...
enum EMenuList
{
	...
	MENU_EQUIPMENT,
	MENU_EQUIPMENT_PRESETS,
	MENU_INVENTORY,
	MENU_INVENTORY_RANDOMBOX_OPEN,
	MENU_INVENTORY_BOX_OPEN,
	MENU_MODULES,
	...
	MOTD_MENU_PERSONAL_ASSISTANT,

	MOTD_MENU_WIKI_INFO,
	MOTD_MENU_WIKI_SELECT,

	MOTD_MENU_CASINO,
	MOTD_MENU_CASINO_CURRENCY_SELECT,
};
...
enum
{
	...
	*/
	...
	itKillGun                      = 208,   // Equipment Kill gun
	itBurstShotgun                 = 209,   // Equipment Burst shotgun
	itInjuryGrenade                = 210,   // Equipment Injury grenade
	itLaserDamager                 = 211,   // Equipment Laser damager
