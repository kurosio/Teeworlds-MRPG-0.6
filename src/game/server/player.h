...
public:
	...
	CElementBox m_CurrentRandomItem {};
...
public:
	...
	bool StartWorldScenario(const std::string& ScenarioData, ScenarioBlock Block, int WorldID, int Single, int DurationSeconds) const;
};
